...
import {
  ...
  ShoppingBag, Edit, Trash2, Upload, Loader2, FileText
} from "lucide-react";
...
function VendorDashboard() {
  ...
  const [activeTab, setActiveTab] = useState("requirements"); // "requirements" or "quotes"
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex gap-4 mb-8 border-b border-gray-200">
            <button
              ...
              className={`pb-4 px-2 font-semibold transition-colors relative ${activeTab === "requirements"
                ? "text-indigo-600"
